...
import { Ideation, Proto } from "@/app/assets";
  ...
  return (
    <div className="bg-[#FAFAFA] py-20 mt-20">
      ...
      >
        ...
        <span className="text-yellow-500 -mt-12 sm:-mt-14 text-[55px] sm:text-[70px]">
          Processes
        </span>
      </h3>
      <div className="flex flex-col md:flex-row items-center mt-10 gap-6 max-w-5xl mx-auto px-4">
        <div className="flex-1 shrink-0">
          ...
          <p>
            ...
            &#34;How Might We&#34; questions and utilizing the Crazy 8&apos;s
            technique.
          </p>
        </div>
        <Image
